...
#find the indeex of the word text
print(result[10:14])
print(result.find('is'))
print(result[5:7])
#reverse the string
print(result[::-1])
#get the last lestter of the string
print(result[-1])
print(result.find('string'))
print(result[15:-1])
print(result.find('hancock'))
#hancock dose not exsist in the string
#-1 means the substring is not found
#Index slicing is when you get a substring from a string.
#You can get a substring by specifying the start and end index of the substring.
...
print(text[0:])
#this gets the first lestter to the last letter
